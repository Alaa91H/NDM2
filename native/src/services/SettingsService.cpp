...
void SettingsService::setNotificationsEnabled(bool value) { if (notificationsEnabled() == value) return; m_settings.setValue("ui/notificationsEnabled", value); emit notificationsChanged(); }
